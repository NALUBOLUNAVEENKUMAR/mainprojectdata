...
Connection con=null;
String sql="select count(*) from reg where email='"+s1+"' and password='"+s2+"'";
...
if(a==1){
	...
	PreparedStatement  pst2=con.prepareStatement("update reg set otp='"+ram+"' where email='"+s1+"' and password='"+s2+"'" );
	pst2.executeUpdate();
...
response.sendRedirect("OLogin3.jsp?raji=1");	
}
catch (Exception err) {
...
//transport.close();
     ...
     else
     {
		...
		response.sendRedirect("OLogin3.jsp?raji=0&&msg=Invalid credentials. Please try again");
