...
<body style="background-color: #05baf9 !important;">
	...
	<header id="header" class="fixed-top">
        ...
        <li ><a href="index.html">Home</a></li>
          <li class="drop-down"><a style="color: white;" href="#">User</a>
            <ul>
			...
			<div class="col-md-9 register-right">
				...
				<div class="tab-content" id="myTabContent">
					<div class="tab-pane fade show active" id="home" role="tabpanel"
						...
						%>
						<%if(raji==1){ %>
						<form name="f1" action="OLogin1.jsp" method="POST"
							onsubmit="return validation()">
<%}else{ %>
							
							<form name="f1" action="OLogin2.jsp" method="POST"
								onsubmit="return validation()">
										...
										<div class="col-md-6">
											<div class="form-group">
												<input type="email" name="email"  class="form-control"
													placeholder="Email Id *" value="<%=session.getAttribute("email") %>" />
											</div>
