			...
			<div class="col-md-9 register-right">
				...
				<div class="tab-content" id="myTabContent">
					<div class="tab-pane fade show active" id="home" role="tabpanel"
						...
						<h3 class="register-heading">Owner Login</h3>

						<%
							int raji=0 ;
							String sa = null;
							sa = request.getParameter("raji");
							//System.out.println(raji + "======================");
							System.out.println(sa + "======sss================");
							if (sa.contains("1")) {
								raji++;
								System.out.println(raji + "======================");
							}
							
							System.out.println(raji + "===========sssss===========");

						%>
						<%if(raji==1){ %>
						<form name="f1" action="OLogin12.jsp" method="POST"
							onsubmit="return validation()">
<%}else{ %>
							
							<form name="f1" action="OLogin22.jsp" method="POST"
								onsubmit="return validation()">
		...
		<%} %>						
										...
										<div class="col-md-6">
											<div class="form-group">
												<input type="email" name="email"  class="form-control"
													placeholder="Email Id *" required="required" value="<%=session.getAttribute("email") %>" />
											</div>
						...
						<%if(raji==0){ %>
											...
											<input type="submit" class="btnRegister" value="Get Otp" />
											
<%}else{ %>

											<div class="form-group">
												<input type="Otp" name="otp" class="form-control"
													placeholder="Otp *" value="" required="required" />
											</div>
