	...
	<header id="header" class="fixed-top">
		<div class="container">
			...
			<div class="logo float-left">
				<h1 class="text-light">
					<a href="#"><span>A Reliability Guaranteed Solution for Data Storing and Sharing</span></a>
				</h1>
			...
			<nav class="nav-menu float-right d-none d-lg-block">
              ...
              <li class="active"><a href="ohome.jsp">Home</a></li>

               <li class="drop-down"><a href="#">Files</a>
            <ul>
              <li class=""><a href="ownerupload.jsp">Upload</a>
              <li class=""><a href="ownerviewfiles.jsp">View</a>
...
PreparedStatement ps=con.prepareStatement("select * from upload where  uid='"+session.getAttribute("un")+"'");
...
<input type="hidden" name="fid" value="<%=rs.getString(1)%>">
<input type="submit" id="popUpYes" value="Delete">
</form>	
</td>
...
<input type="hidden" name="fid" value="<%=rs.getString(1)%>">
<input type="submit" id="popUpYes" value="Requests"> <sup style="font-size: 15px"><b>*</b></sup>
...
<%-- td> 
<form action="verfiedfiles.jsp">
<input type="hidden" name="fid" value="<%=rs.getString(1)%>">
<input type="submit" id="popUpYes" value="Verfies"> <sup style="font-size: 15px"><b>*</b></sup>
