...
PreparedStatement ps=con.prepareStatement("select * from groupaccessfiles where fileid='"+request.getParameter("fid")+"' and foid='13' and ownerstatus='Pending'");
...
<a href="gpreqaccept.jsp?rid=<%=rs.getString(1)%>&&respo=Accepted">Accept</a> 
/
<a href="gpreqaccept.jsp?rid=<%=rs.getString(1)%>&&respo=Rejected">Reject</a> 
