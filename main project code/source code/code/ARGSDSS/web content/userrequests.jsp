	...
	<header id="header" class="fixed-top">
		<div class="container">
			...
			<nav class="nav-menu float-right d-none d-lg-block">
              ...
              <li class="active"><a href="dphome.jsp">Home</a></li>
              
              <!--  <li class="drop-down"><a href="#">Files</a>
            <ul> -->
              <li class=""><a href="ownerfiles.jsp">Owner Files</a>
...
PreparedStatement ps=con.prepareStatement("select * from userreques,upload,reg where reg.id=userreques.userid and userreques.fid=upload.fid and userreques.dpid='2' and userreques.status='pending'");
...
while(rs.next()){
	...
	<tr>
		...
		<td>
	<%
		out.println(rs.getString(15)+" "+rs.getString(16));
	...
	<td>
<a href="gpreqacceptss.jsp?rid=<%=rs.getString(1)%>">Accept</a> 
</td>
